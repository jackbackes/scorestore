...
//             return guestAgent.get( '/api/v1/user/1 ' )
//               .expect( 200 )
//               .end( ( err, response ) => {
//                 if ( err ) throw err;
...
//             return adminAgent.get( '/api/v1/user/1' )
//               .expect( 200 )
//               .end( ( err, response ) => {
//                 if ( err ) throw err;
...
//               return authdAgent.get( '/api/v1/user/1' )
//                 .expect( 200 )
//                 .end( ( err, response ) => {
//                   if ( err ) throw err;
//                   response.body.should.have.all.keys( 'password', 'isAdmin', 'isGuest', 'email' );
...
//               return adminAgent.delete( '/api/v1/user/3' )
//                 .expect( 204 )
//                 .end( ( err, response ) => {
//                   if ( err ) throw err;
...
//               return authdAgent.delete( '/api/v1/user/1' )
//                 .expect( 204 )
//                 .end( ( err, response ) => {
//                   if ( err ) throw err;
...
//               return adminAgent.put( '/api/v1/user/1' )
...
//               return authdAgent.put( '/api/v1/user/1' )
//                 .send( JSON.stringify( patchUser1 ) )
//                 .expect( 200 )
//                 .end( ( err, response ) => {
//                   if ( err ) throw err;
...
//               return guestAgent.put( '/api/v1/user/3' )
//                 .send( JSON.stringify( patchUser1 ) )
//                 .expect( 401 )
//             } )
...
//     xit( '/:orderId -- authorized user can only use these routes for their own account', function () {
//       return Promise.all( [
...
//       ] )
//     } )
//     xit( '/:orderId -- admin can use these routes for any account', function () {
//       return Promise.all( [
...
//     } )
//     describe( 'POST', function () {
//       xit( 'creates a new order', function () {
//         return Promise.all( [
...
//         ] )
//       } )
//       xit( 'admin can create order for another user', function () {
    ...
    describe( '/:id', function () {
      describe( 'GET', function () {
        it( 'retrieves a specific song', function () {
          return Promise.all( [
            adminAgent.get( '/api/v1/songs/1' )
            .expect( 200 ),
            guestAgent.get( '/api/v1/songs/2' )
            .expect( 200 ),
            authdAgent.get( '/api/v1/songs/3' )
            .expect( 200 )
          ] )
        } )
      } )
      describe( 'DELETE', function () {
        it( 'admin-only', function () {
          return Promise.all( [
            adminAgent.delete( '/api/v1/songs/1' )
            .expect( 204 ),
            guestAgent.delete( '/api/v1/songs/2' )
            .expect( 401 ),
            authdAgent.delete( '/api/v1/songs/3' )
            .expect( 403 )
          ] )
        } )
        it( 'deletes a specific song', function () {
          return adminAgent.delete( '/api/v1/songs/1' )
            .expect( 204 );
        } )
      } )
      describe( 'PUT', function () {
        it( 'admin-only', function () {
          return Promise.all( [
            adminAgent.put( '/api/v1/songs/1' )
            .expect( 200 ),
            authdAgent.put( '/api/v1/songs/2' )
            .expect( 403 ),
            guestAgent.put( '/api/v1/songs/3' )
            .expect( 401 )
          ] )
        } )
        it( 'updates a specific song', function () {
          return adminAgent.put( '/api/v1/songs/1' )
            .expect( 200 )
        } )
      } )
    } )
